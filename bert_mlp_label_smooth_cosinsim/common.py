...
def construct_y(y,levels,p1=0.7,p2=0.75,p3=0.8,p4=0.85,p5=0.9,p6=0.95,p7=1.0):
    positive = [p1,p2,p3,p4,p5,p6,p7]
    negtive = [1-p1,1-p2,1-p3,1-p4,1-p5,1-p6,1-p7]

    target_y=[0 for i in range(232)]
    for i in range(232):
        if y[i]==0:
            target_y[i]=negtive[levels[i]-1]
        else:
            target_y[i]=positive[levels[i]-1]
    return target_y
